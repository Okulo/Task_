                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left mr-3">
                                                    <img :src="avatar"  width="42" class="rounded-circle"  alt="">
                                                </div>
                                                <div class="widget-content-left" id="contacts">
                                                    <div class="widget-heading">{{fio}}</div>
                            ...
                            <div class="scroll-area-xs" style="height: 150px;">
                                <VuePerfectScrollbar class="scrollbar-container" v-once>
                                    <ul class="nav flex-column">
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Пользователи</a></li>
                                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link">Finance</a></li>
        ...
        data: () => ({
            ...
            showDrawerSection: false
              ...
              mounted(){
                ...
                axios.post("https://dev-api.ringapp.me/auth", {email: "testalina@mailsecv.com",  password:   "1q2w3e4r5t"})
                .then(response => {
                    
                var token  = response.data.token;       
               //this.message = response.data.token;
                axios.get("https://dev-api.ringapp.me/profile" , {
                headers: {
