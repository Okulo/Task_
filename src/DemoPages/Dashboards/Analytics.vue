    ...
    <div>
                ...
                <div class="col-sm-12 col-md-12 col-xl-12">
                    <div class="card no-shadow rm-border bg-transparent widget-chart text-left">
                        ...
                        <div class="widget-chart-content">
                            <div class="widget-numbers" id="info"></div>
                            <span>{{message}}</span>
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="card-hover-shadow-2x mb-3 card">
                    <div class="card-header-tab card-header">
                        <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="header-icon lnr-database icon-gradient bg-malibu-beach"> </i>Tasks List Analytics</div>
                        <div class="btn-actions-pane-right text-capitalize actions-icon-btn">
    ...
    export default {
        ...
        data: () => ({
         ...
         slickOptions2: {
            ...
            items: [
                { isActive: true, age: 41, first_name: 'Dickerson', last_name: 'Macdonalfd' },
